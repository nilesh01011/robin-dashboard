        ...
        <>
            <div className='w-full h-full'>
                ...
                <div className={`w-full border-b-[1px] ${theme === 'dark' ? 'border-[#635D5D]' : 'border-[#DEDEDE]'}`}>
                    <h1 className='pb-[8px] relative w-max font-semibold text-[18px]'>
                        DASHBOARD
                ...
                {/* main content body */}
                <div className='w-full h-full flex mt-[15px] slg:mb-[20px] mb-[25px] items-start justify-between flex-wrap xl:flex-row'>
